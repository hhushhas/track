...
const SYMBOLS: Record<IconName, SymbolDefinition> = {
  ...
  evidence: { android: 'fact_check', ios: 'doc.text.magnifyingglass' },
  ...
  'office-building': { android: 'apartment', ios: 'building.2', iosFilled: 'building.2.fill' },
  ...
  subtask: { android: 'account_tree', ios: 'arrow.turn.down.right' },

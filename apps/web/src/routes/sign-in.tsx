...
const previewMessages = [
  {
    ...
    tone: 's-2',
    time: '4:45:45 PM',
    body: 'Please make review requirements visible. Our promise is that every seller and product is reviewed before it reaches shoppers.',
  },
  {
    initials: 'SK',
    name: 'Sara Khan',
    tone: 's-2',
    time: '4:52:45 PM',
    body: 'capture review requirements and product review as an official launch requirement.',
    mention: '@track',
  },
  {
    initials: 'TA',
  ...
  },
  {
    ...
    tone: 's-2',
    time: '5:41:45 PM',
    body: 'Can the project summary show which requests are billable versus included? That would help me share it internally.',
  },
  {
    initials: 'OF',
    name: 'Omar Farooq',
  ...
  },
  {
    ...
    tone: 's-3',
    time: '5:59:45 PM',
    body: 'I am keeping the launch review, delivery promise, and reorder workflow in this thread for the next pass.',
  },
]
          ...
          {isConversationVariant ? (
            ...
            <>
              <div>
                ...
                <p>
                  Track unifies project conversation and task management around decisions,

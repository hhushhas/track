const knownCompanyErrors: ReadonlyMap<string, string> = new Map([
  ...
  ["company_admin_required", "Only a Company admin can change member roles."],
  ["company_member_update_required", "Choose a member change before saving."],
  ["company_owner_required", "Only the Company owner can transfer ownership."],
  ["last_company_owner", "Keep at least one active Company owner."],
